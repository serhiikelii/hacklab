# HackLab - Apple Service Center

Веб-сайт для сервисного центра Apple устройств в Праге с видео-трансляцией ремонта и онлайн записью.
...
HackLab использует **Supabase PostgreSQL** с:
