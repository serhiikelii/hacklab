...
export function HeroSection() {
  ...
  return (
    <section className="relative py-16 md:py-20 lg:py-24 min-h-[450px] md:min-h-[495px] lg:min-h-[540px] bg-cover bg-bottom bg-no-repeat overflow-hidden bg-white" style={{ backgroundImage: 'url(/images/backgrounds/hero-bg.webp)' }}>
      <div className="container mx-auto px-4 relative z-10 h-full">
        <div className="flex items-center justify-end h-full min-h-[405px] md:min-h-[450px] lg:min-h-[495px]">
