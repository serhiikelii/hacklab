...
const bannerVariants = {
  promo: {
    ...
    outline: 'bg-white/80 backdrop-blur-sm border-2 border-cyan-600 text-cyan-900',
  },
  sale: {
    ...
    outline: 'bg-white/80 backdrop-blur-sm border-2 border-green-600 text-green-900',
  },
  warning: {
    ...
    outline: 'bg-white/80 backdrop-blur-sm border-2 border-red-600 text-red-900',
  },
  info: {
    ...
    outline: 'bg-white/80 backdrop-blur-sm border-2 border-blue-600 text-blue-900',
  },
} as const

type BannerVariant = keyof typeof bannerVariants

function getBannerClasses(type: AnnouncementType, theme: AnnouncementTheme = 'glossy'): string {
